on clicked theObject
	...
	set chosenCalendar to choose from list calTitles with prompt "Add to which calendar?" cancel button name "Cancel" OK button name "Add to iCal" default items (first item of calTitles) without empty selection allowed and multiple selections allowed
	...
	if addedItems is true then
		tell application "iCal"
			...
			tell application "System Events" to click menu item "iCal" of menu "Window" of menu bar item "Window" of menu bar 1 of process "iCal"
